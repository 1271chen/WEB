...
<html>
  ...
  <body>
    <body>
    <center>
        <font size=6>协议支付</font>
        <form action="CNP/QPay02/QPay2.jsp" method="post">
		<table border="1">
		  <tr>
			<td>版本号（version）</td>
		  ...
		  <tr>
			<td>交易金额（amount）</td>
			<td><input type="text" name="amount" value="200" /></td>
		  </tr>
		  <tr>
			<td>payToken</td>
			<td><input type="text" name="payToken" value="8120000000000156818" /></td>
		  </tr>
